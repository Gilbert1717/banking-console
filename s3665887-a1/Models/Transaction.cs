...
public class Transaction
{
    ...
    public Transaction(TransactionType transactionType, int accountNumber, decimal amount,
        string? destinationAccountNumber, string? comment, DateTime transactionTimeUtc)
    {
    ...
    public Transaction(int transactionId, decimal amount, TransactionType transactionType, int accountNumber,
        string? destinationAccountNumber, string? comment, DateTime transactionTimeUtc)
    {
